...
rem Pythia uses the system Python. Prefer the exact 32-bit version via the py
rem launcher, falling back to whatever "python" is on PATH.
set PYCMD=py -{version_dotted}-32
